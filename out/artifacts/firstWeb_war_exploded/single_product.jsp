...
<head>
    ...
    <style type="text/css">
        #productZoom:after {
            ...
            background: url(jquery-zoom/icon.png);
        }
...
<div class="site-wrap">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <strong
                        class="text-black">PSR-Series</strong></div>
            </div>
        </div>
    </div>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-6 d-flex justify-content-center align-items-center" id="productZoom">
                    <img src="images/piano_1.jpg" alt="Image" class="img-fluid">
                    <p>hover</p>
                </div>
                <div class="col-md-6">
                    <%
                        Product product = (Product) session.getAttribute("product");
                        out.write("<h2 class='text-black'>" + product.getName() + "</h2>");
                    %>
                    ...
                    <%
                        out.write("<p><strong class='text-primary h4'>" +"$ "+ product.getPrice() + "</strong></p>");
                    %>
                    <form method="post">
                        <div class="mb-5">
                        ...
                        <p>
                            <input type="submit" class="btn btn-primary btn-sm" value="Add To Cart"
                                   onclick="this.form.action='./cart'"/>
                            <input type="submit" class="btn btn-primary btn-sm" value="Buy it Now"
                                   onclick="this.form.action='./singlecheck'"/>
                        </p>
                    </form>
                </div>
            </div>
                    ...
                    <div class="nonloop-block-3 owl-carousel">
                        <%
                            ...
                            for (int i = 0; i < productList.size(); i++) {
                                ...
                                out.write("<figure class='block-4-image'><img src='images/P_series.jpg' alt='Image placeholder'");
                                out.write("class='img-fluid'></figure>");
...
<script type="text/javascript" src="jquery-zoom/jquery.zoom.js"></script>
