              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <%
                      OrderMessage Order = (OrderMessage) session.getAttribute("CheckOrderMessage");
                    %>
                    <input type="text" class="form-control" id="c_fname" name="c_fname" value="<%=Order.getfName()%>">
                  </div>
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Last Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_lname" name="c_lname" value="<%=Order.getlName()%>">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_address" class="text-black">Address <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_address" name="c_address" placeholder="Street address" value="<%=Order.getAddress()%>">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_phone" class="text-black">Phone Number <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_phone" name="c_phone" value="<%=Order.getfName()%>">
                  </div>
                </div>
                  ...
                  <div class="p-3 p-lg-5 border">
                    <table class="table site-block-order-table mb-5">
                      ...
                      <%int price = 0;
                          ...
                          List<CartProduct> productList = (List<CartProduct>) session.getAttribute("OrderItemList");
                    ...
                    <div class="form-group">
                      <input type="submit" class="btn btn-primary btn-lg py-3 btn-block" value="Change Order">
                      <a href="./cancelorder" class="btn btn-primary btn-lg py-3 btn-block" >Cancel Order</a>
                    </div>
