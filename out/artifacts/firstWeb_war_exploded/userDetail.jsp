      ...
      <div class="row justify-content-center">
        <div class="col-lg-12 col-md-12 p-3 m-3" data-aos="fade-up" data-aos-delay="200s">
          <table class="table table-striped">
            ...
            <tr>
              ...
              <%
                ...
                out.write("<td>"+user.getNickName()+"</td>\n");
                out.write("<td>"+user.getUserPhone()+"</td>\n");
                out.write("<td>"+user.getUserEmail()+"</td>\n");
              %>
          ...
          <div class="col-lg-6 col-md-6 m-auto">
            <input type="button" class="btn btn-primary dropdown-toggle m-auto" value="Change your information" style="width: 100%;height: 100%">
            </input>
          </div>
          <div class="col-lg-12 col-md-12 toggle" style="display: none; ">
            <div class="text-center">
              <strong>The fix of information table</strong>
            </div>
            <div>
              <form action="./changeinfo" method="post">
                <table class="table table-striped">
                  ...
                  <tr>
                    <%--               id passwod phone email --%>
                    <td><label for="UserPassword"></label><input type="password" name="password" placeholder="Empty for no change" id="UserPassword"/>
                      <div class="invalid-feedback" id="userpswd1-feedback" ></div></td>
                    <td><label for="UserName"></label><input type="text" name="nickname" placeholder="Empty for no change" id="UserName"/>
                      <div class="invalid-feedback" id="nickname-feedback"></div></td>
                    <td><label for="UserPhone"></label><input type="text" name="phone"
                            placeholder="Empty for no change"  oninput = "value=value.replace(/[^\d]/g,'')" id="UserPhone"/>
                      <div class="invalid-feedback" id="userphone-feedback"></div></td>
                    <td><label for="UserEmail"></label><input type="email"
                                                              placeholder="Empty for no change" name="email" id="UserEmail"/>
                      <div class="invalid-feedback" id="useremail-feedback"></div></td>
                  </tr>
                  <tr>
                    <td colspan="4">
                      <div class="col-lg-4 col-md-4 m-auto"><input type="submit" class="btn btn-success m-auto" value="submit" style="width: 100%;height: 100%"/></div>
                    </td>
                  </tr>
                  </tbody>
                </table>
...
<script type="text/javascript">
  $(function () {
    $(".btn").click(function () {
      $(".toggle").toggle();
      if ($(this).val()=="Change your information"){
        $(this).val("show")
      }else {
        $(this).val("Change your information")
      }
    })
  })
</script>
