...
<%@ page import="service.*" %>
<%@ page import="servlet.ProductListServlet" %>
<%@ page import="vo.*" %>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="col-md-9 order-2">
                        ...
                        <div class="col-md-12 mb-5">
                            ...
                            <div class="d-flex">
                                <div class="dropdown mr-1 ml-md-auto">
                                    <button type="button" class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuOffset" data-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                        Orderd By
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                        <a class="dropdown-item" href="./Otime">Latest Launch Time</a>
                                        <a class="dropdown-item" href="./orderbyprice?HOL=0">Price from low to high</a>
                                        <a class="dropdown-item" href="./orderbyprice?HOL=1">Price from high to low</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <%
                            ...
                            String s = request.getParameter("pagePara");
                            Integer pageID = 1;
                            if (s!=null)
                            pageID = Integer.parseInt(s);
                           // Integer pageID = request.getParameter("pans");
                            if(productList!=null){
                                if (pageID*6>productList.size())
                                    for (int i = (pageID-1)*6;i<productList.size();i++){
                                        Product product = productList.get(i);
                                        out.write("<div class='col-sm-6 col-lg-4 mb-4' data-aos='slide-left'>");
                                        out.write("<div class='block-4 text-center border'>");
                                        out.write("<figure class='block-4-image'>");
                                        out.write("<a href='./product?productID="+product.getIid()+"'>");
                                        ...
                                        out.write("<p class='mb-0'>"+product.getSuperclass()+"</p>");
                                        out.write("<p class='text-primary font-weight-bold'>"+product.getPrice()+"</p>");
                                        out.write("</div></div></div>");
                                    }
                                else
                                    for(int i = (pageID-1)*6;i<(pageID)*6;i++){
                                        Product product = productList.get(i);
                                        out.write("<div class='col-sm-6 col-lg-4 mb-4' data-aos='slide-left'>");
                                        out.write("<div class='block-4 text-center border'>");
                                        out.write("<figure class='block-4-image'>");
                        ...
                        <div class="col-md-12 text-center">
                            <div class="site-block-27">
                                <ul>
                                    <%
                                        if (pageID!=1){
                                            out.write("<li><a href='productList.jsp?pagePara="+(pageID-1)+"'>&lt;</a></li>");
                                            out.write("<li><a href='productList.jsp?pagePara="+(pageID-1)+"'>"+(pageID-1)+"</a></li>");
                                        }

                                    %>
                                    <li class="active"><span><%=pageID%></span></li>
                                    <%
                                        if (pageID*6<productList.size())
                                            out.write("<li><a href='productList.jsp?pagePara="+(pageID+1)+"'>"+(pageID+1)+"</a></li>");
                                        if (pageID*6+6<productList.size())
                                            out.write("<li><a href='productList.jsp?pagePara="+(pageID+2)+"'>"+(pageID+2)+"</a></li>");
                                        if (pageID*6<productList.size())
                                            out.write("<li><a href='productList.jsp?pagePara="+(pageID+1)+"'>&gt;</a></li>");
                                    %>
                ...
                <div class="col-md-3 order-1 mb-5 mb-md-0">
                    <div class="border p-4 rounded mb-4">
                        ...
                        <ul class="list-unstyled mb-0">
                            <%
                                List<Catagory> CatagoryList = (List<Catagory>) session.getAttribute("Catagory");
                                int k=0;
                                for (Catagory catagory:CatagoryList){
                                    k++;
                                   out.write("  <li class='mb-1'><a href='./productlist?CatagoryFlag="+catagory.getName()+"' class='d-flex'><span>"+catagory.getName()+"</span> <span class='text-black ml-auto'>("+catagory.getNum()+")</span></a></li>");
                                }
                            %>
                        </ul>
                    </div>
                    ...
                    <div class="border p-4 rounded mb-4">
                      <form action="./filter" method="get">
                        <div class="mb-4">
                                ...
                                <input type="text" name="amount" id="amount" class="form-control border-0 pl-0 bg-white" readonly="readnoly" />
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-6 col-lg-6 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                                <a class="block-2-item" href="#">
                                    <figure class="image">
                                        <img src="images/portable_organ.jpg" alt="" class="img-fluid">
                                    </figure>
                                    <div class="text">
                                        <span class="text-uppercase">Collections</span>
                                        <h6>
                                            <font color="#FCFCFC">Portable Organ</font>
                                        </h6>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="100">
                                <a class="block-2-item" href="#">
                                    <figure class="image">
                                        <img src="images/piano.jpg" alt="" class="img-fluid">
                                    </figure>
                                    <div class="text">
                                        <span class="text-uppercase">Collections</span>
                                        <h6>
                                            <font color="#FCFCFC">Electric Piano</font>
                                        </h6>
                                    </div>
                                </a>
                            </div>
...
<script>
    function reloadPage(a){
        document.getElementById("pans").value = a;
        location.reload()
    }
