...
<div class="site-wrap">
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Login</strong></div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <form onsubmit="return checkFormofLogin()" action="./login" method="post">

                        <div class="p-3 p-lg-5 border">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="UserID" class="text-black">User Name <span class="text-danger">*</span></label>
                                    <input onblur="checkFormofLogin()" type="text" class="form-control" oninput = "value=value.replace(/[^\d]/g,'')" id="UserID" name="UserID" placeholder="Enter your pure numeric ID">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input onblur="checkFormofLogin()" type="password" class="form-control" id="UserPassword" name="UserPassword" placeholder="Type your password">
                ...
                <div class="col-md-12">
                    <a href="signUp.jsp">Forget your password?</a>
                </div>
                <div class="col-md-12">
...
<%
    String mess=(String)session.getAttribute("Passwordmatch");
